...
| [D-7](0007-embeddings-first-clustering.md) | Embeddings-first clustering | cluster-structural |
| [D-8](0008-git-repos-as-cluster-seeds.md) | Git repos as cluster seeds | cluster-structural |
| [D-9](0009-hash-keyed-summary-cache.md) | Hash-keyed summary cache | cluster-semantic |
...
| [D-22](0022-git-repo-curated-summary.md) | Git-repo curated summary | ingest |
...
| [D-26](0026-single-global-similarity-threshold.md) | Single global similarity threshold | cluster-structural |
| [D-27](0027-hdbscan-over-unassigned-only.md) | HDBSCAN over unassigned only | cluster-structural |
| [D-28](0028-incremental-reclustering-by-default.md) | Incremental re-clustering by default | cluster-structural |
...
| [D-40](0040-cross-cluster-as-separate-stage.md) | Cross-cluster as separate stage | cross-cluster |
| [D-41](0041-cross-cluster-conservative-scope.md) | Cross-cluster conservative scope ⚠ flagged | cross-cluster |
| [D-42](0042-annotations-as-sidecar-files.md) | Annotations as sidecar files | cross-cluster |
| [D-43](0043-cross-cluster-always-runs.md) | Cross-cluster always runs by default | cross-cluster |
| [D-44](0044-hard-candidate-cap-halt-warn.md) | Hard candidate cap (halt-and-warn) | cross-cluster |
...
| D-49..D-52 | Cluster archival semantics | Deferred — not needed in PoC timeframe. |
